const superagent = require('superagent'); //20k (gzip)
...
const loacl = 'jiangxi/qingshanhu-district';
const weatherUrl =  `https://tianqi.moji.com/weather/china/${loacl}`;
...
function getSpiderData() {
  ...
  .then(spiderArr => {
    //spiderArr 数组 由promise resolve 出来的数据组成
...
function  sendEmail(htmlData){
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: '466933292@qq.com',
      pass: 'yxejxcukswoccaeb'
    }
  })
  transporter.sendMail(
    {
        from: '超大只胖狗<466933292@qq.com>',
        to: '362392851@qq.com',
        subject: '邮件',
        html: html
    },
